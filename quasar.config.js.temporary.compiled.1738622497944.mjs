...
var quasar_config_default = defineConfig(function() {
  return {
    supportTS: true,
    eslint: {
      // fix: true,
    ...
    devServer: {
      ...
      proxy: {
        "/api": {
          ...
          pathRewrite: {
            "^/api": ""
            // Rewrites the URL prefix if needed
          }
        }
      }
    },
    ...
    typescript: {
      ...
      vueShim: true,
      // required when using ESLint with type-checked rules, will generate a shim file for `*.vue` files
