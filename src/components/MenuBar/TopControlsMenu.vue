<template>
  <div class="top-controls">
    <div>
      ...
      <q-item style="margin-top: -12px; margin-bottom: -8px">
        <q-select
          borderless
          dense
          behavior="menu"
...
export default {
  ...
  methods: {
    ...
    async setLanguage(localeString) {
      await this.loadLocaleMessages(i18n, localeString);
      this.setI18nLanguage(i18n, localeString);
      this.setLocale(localeString);
      this.languagePref = localeString;
    },
    setDarkMode(value) {
