...
export default {
  ...
  error_codes: {
    ...
    no_location: 'Check that partymap.com has permission to access your location.'
  },
  user_profile: {
    my_events: 'My events',
    delete: 'Delete',
    ...
    delete_event_confirm: "Are you sure you want to delete this event? This can't be undone",
  ...
  manage_account: {
    ...
    facebook_login_message_2: 'You must create a password below if you would like to be able to log in with your email address.',
    email_address: 'Email address',
    update_email: 'Update email address',
    email_verification: 'Email verification',
    email_verification_msg: "We've sent you a verification email. You'll need to click the link in the email to complete the process.",
    ...
    delete_account_msg: 'Deleting your account will also delete all of your contributions to PartyMap.',
  ...
  auth: {
    ...
    invite_email_body: 'Hi, my name is... %0A%0A%0AI am from...%0A%0AI want to be on Partymap because... %0A%0AThe events me or my organization host are... %0A%0A%0A%0AThanks!',
    ...
    request_invite_message: 'Tell us a little bit about yourself and the events that you or your organization host and we will get back to you.',
    ...
    create_message: 'Choose a username that represents your organization or your events.',
    ...
    choose_username_message: 'Your username is how other people will see you on PartyMap. You can use your real name, a psuedonym or your organizations name.',
    choose_username_requirements: 'Your username must only contain letters and numbers.',
    continue: 'Continue',
    ...
    account_activate_error_msg:
      ...
      account_already_activated_error_msg: 'Your account has already been activated',
    forgot_password: 'Forgot your password?',
    forgot_password_message: "We'll send you an email containing a link to a page where you can reset your password.",
    reset_password: 'Reset password',
    nearly_there: 'Nearly there!',
    success: 'Success!',
    password_reset_email_sent: "We've sent you an email, check your inbox!",
    your_pw_has_been_reset_and_logged_in_as: 'Your password has been reset and you are now logged in'
  ...
  add_event: {
    ...
    event_i_know_about_msg: 'Anyone can submit an event to PartyMap, as long as the event information is already public on the internet.',
    event_i_know_about_msg_long: 'Anyone can submit an event to PartyMap, as long as the event information is already public on the internet. Anyone will be able update the event page if the information becomes out of date. All events are moderated before they show on the map.',
    i_am_host: "I'm the host",
    i_am_host_msg: 'Login required. We may also ask for verification before publishing your event.',
  ...
  add: {
    ...
    suggested_tags: 'Some ideas: festival, cultural, spiritual, camping, free, hiphop, trance, metal, alcohol free, psychedelic, drug testing, wheelchair accessible...',
    ...
    please_select_date_msg: 'Select a range if the event will happen over multiple days',
    please_select_date_msg_2: "If it's a one-day event you will need to double click to select the day.",
    ...
    size_msg2: 'Just a rough estimate - please round to the nearest hundred or thousand attendees',
    size: 'Size',
    size_how_many: 'Size',
    url: 'External URL',
    url_msg: 'A link to the website or Facebook page (Click the share button on the Facebook event page to get a nice link).',
    add_event_date: 'Add date',
    uploading_event: 'Uploading this event to PartyMap...',
    pending_moderation: 'Pending moderation',
    pending_moderation_msg: 'This event will show on the map after we have approved it.',
    lineup: 'Lineup',
    lineup_msg: 'Add artists and performance times to the lineup for this event. If there is more than one stage at this event you can use the plus sign to add additional stages.',
    required_information: 'Required information',
    additional_information: 'Additional information',
    an_event_already_exists: 'An event already exists with a simlar name ',
    dont_add_same_twice: "Please don't add the same event twice, instead you should update the original page.",
    dont_add_same_twice2: 'If this is a different event you can ignore this warning.',
    event_poster_image: 'Event poster/cover image',
    event_poster_image_msg: 'Upload a promotional image for this event.',
    event_poster_image_msg2: 'We recommend a portrait poster for the best look!',
  },
  add_event_date: {
  ...
  description: {
    ...
    summary: 'Summary',
    attribute_msg: 'Please give the source so we can attribute the original writer',
    attribute_msg_long: 'If you did not write this yourself, please give the source.',
    summary_msg: 'A short description that will be shown at the top of the event page. Keep it short and sweet.',
    detailed_description: 'Detailed description',
    detailed_description_msg: 'A detailed description of this upcoming event.',
    put_more_details_in_event_date: 'You can put a more detailed description in the event date section further down the page.',
  ...
  activity: {
    ...
    page_versions_message: 'Use the slider to browse previous versions of this page. ',
  ...
  suggestions: {
    ...
    improve_this_page_msg: 'If the information on this page is incorrect you can help other people by updating it! All updates are moderated.',
    general: 'General',
    ...
    main_description_msg: 'Edit the short summary that shows at the top of the event page',
    event_tags: 'Tags',
    ...
    schedule_msg: 'PartyMap can automatically add future dates if this event happens on a regular basis',
    remove_schedule: 'Remove schedule',
    remove_schedule_msg: 'Stop automatically generating dates if this event no longer happens on a regular basis',
    date: 'Date and time',
    ...
    ed_description_msg: 'Suggest changes to the description for this specific event date',
    url: 'External URL',
    url_msg: 'Suggest a new URL that links to the events website or Facebook event page',
    ...
    tell_us_why_improvement_needed: 'Tell us why this improvement is needed. Please give a source if possible.',
    ...
    artists: 'Lineup',
    artists_msg: 'Add artists and performance times to the lineup for this event. If there are several stages or the event happens over multiple days, you can organize the lineup by creating separate lists.',
  ...
  gallery: {
    ...
    edit_gallery_message: 'The first three items will be shown as the event cover. Video is supported. ',
    reorder: 'Re-order',
    uploading_media: 'Uploading media',
    do_do_do: 'Do do doo do..',
    video_conversion_msg: 'Videos may take up to 10 minutes to be processed after uploading.'
  },
  event_dates: {
    upcoming_dates: 'Upcoming dates',
    no_upcoming_dates: 'No upcoming dates',
    this_event_doesnt_have_upcoming_dates: "This event doesn't have any upcoming dates",
    next_event: 'Next event',
    edit: 'Edit date',
    description: 'Event date details',
    event_details:'Details:',
    delete_event_date: 'Delete event date',
    delete_event_date_confirm: 'Are you sure you want to delete this event date?',
    done: 'Done',
    edit_message: 'Edit info about this specific date',
    edit_event_rrule: 'Edit recurrance',
    set_up_recurring_dates: 'Set up schedule',
    set_up_recurring_dates_warning: 'If you set an automatic recurrence rule, all future manual dates will be lost.',
    select_date_time_of_next_event: 'Select the date and time of the next event',
    ...
    add_event_date_q_msg: "This event doesn't have any dates so it won't show on the map. If the event has not been completely cancelled, add a date for the next occurance of this event.",
    ...
    change_schedule: 'Change schedule',
    remove_schedule: 'Remove schedule',
    remove_schedule_confirm: 'Are you sure? All future scheduled dates will be deleted.',
    schedule_msg: 'Schedule is enabled, future dates will be automatically generated.',
    lineup: 'Lineup:'
  },
  edit_event_date: {
    ...
    external_url_msg: 'Add a link to the website or Facebook page (Click the share button on the Facebook event page to get a nice link).',
    size: 'Size',
    size_msg: 'Roughly how many people will be attending this event?',
    description: 'Description',
    description_msg: "What's happening on this date?",
    date: 'Date and time',
    date_msg: 'Select the start and end date if this event happens over multiple days, or double click a date to select a single day. Time is in 24 hour format.',
    location: 'Event location',
    location_msg: "This search uses Google so most venues and places should show up. If it's in a paddock just type in the rough address",
    cancel: 'Mark this date as cancelled',
    cancel_msg: "Don't be a bloody dickhead, only do this if this date has been cancelled.",
    uncancel: 'Mark this date as happening',
    uncancel_msg: "This date was previously marked as cancelled. Are you really sure you want to mark is as 'happening'? Don't be a bloody dickhead.",
    delete: 'Delete this event date',
    delete_confirm_1: 'You are about to delete the event date',
    delete_confirm_2: "Don't be a bloody dickhead. Are you sure you want to continue?",
    submit_improvement: 'Submit improvement',
    submit_improvement_msg: 'Tell us why this improvement is needed or give a source if relevant.',
    submitting: 'Submitting...',
    submitted: 'Suggestion submitted',
    submitted_msg: 'Your suggestion will show on the page after it has been reviewd. Thanks for contirbuting to PartyMap!'
  },
  event_date_inline: {
    starts: 'Starts',
    ends: 'Ends',
  ...
  edit_event: {
    remove_schedule: 'Remove schedule',
    remove_schedule_msg: 'Does the event not happen on a regular schedule anymore? This action will delete all future scheduled event dates.',
    updating_event: 'Updating event...'
  },
  tags: {
    tag_event: 'Edit tags',
  ...
  feedback: {
    ...
    send: 'Send',
    give_feedback_msg: "Let me know what you like and don't like about PartyMap. Tell me your hopes and dreams. Share with me your darkest secrets.",
    give_feedback_msg_2: 'If you would like a response please leave your email address.',
    contact_email: 'Contact email',
    sending_feedback: 'Sending feedback...',
    thanks: 'Thanks!',
    thanks_msg: "Your feedback has been sent. If you left us your email address, we'll get back to you soon."
  },
  report: {
    report_event: 'Report event',
    sending_report: 'Sending report',
    please_tell_us_your_problem: 'Please tell us what your problem is with this event.',
    ...
    claim_message: 'We need evidence that this is your event so that we can verify that you are the host. The easiest way is to become a verified host is to message PartyMap on',
    or_from_your_email: 'from your official event account OR sign into a PartyMap account with an email address that has your official domain name in it. You can do this after submitting the event.',
    or: 'or',
    claim_message_2: 'Once you are verified as the host you will have full control over your event page and the verified badge will show.',
    claim_input_msg: 'Tell us how you would like to verify yourself as the host'
  },
  about: {
    mission: 'PartyMap’s mission is to bring people together and promote off-line social connection by making it easy to discover festivals and events around the world.',
    message: 'PartyMap is a community-driven platform for discovering festivals and events around the world. I built it because I wished something like this existed. iOS and Android apps are in the pipeline and I’m planning to translate PartyMap into as many languages as possible. If you speak another language and can help with this, please get in touch! Otherwise, if you have any thoughts, ideas or complaints about PartyMap you can contact me through the feedback form or by email to ' ,
    message_2: 'If your event has been listed by someone and you would like to have it removed, please look for the report button at the bottom of the event page. ',
    message_3: 'Enjoying PartyMap? A lot of time and energy went into it, and server costs are ongoing. You can send a donation with',
    or: 'or',
